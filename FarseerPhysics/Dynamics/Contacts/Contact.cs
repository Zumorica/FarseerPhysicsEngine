...
#pragma warning disable CS0162
                    {
                        ...
                        if (FixtureA.OnCollision != null)
                            foreach (var @delegate in FixtureA.OnCollision.GetInvocationList())
                            {
                                var handler = (OnCollisionEventHandler) @delegate;
                        ...
                        //user subscribed to.
                        if (FixtureB.OnCollision != null)
                            foreach (var @delegate in FixtureB.OnCollision.GetInvocationList())
                            {
                                var handler = (OnCollisionEventHandler) @delegate;
